defmodule AthenaWeb.ItemGroupController do
  ...
  def create(conn, %{"item_group" => item_group_params, "event" => event}) do
    ...
    case Inventory.create_item_group(event, item_group_params) do
      {:ok, item_group} ->
        ...
        |> redirect(to: Routes.item_group_path(conn, :show, item_group))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.item_group_path(conn, :index, event_id))
  end
end
